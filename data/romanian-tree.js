...
export function BuildLanguageTree() // returns romanian
{
    ...
    const noun_feltTipPen = new NounMale("felt-tip pen", "marker", "markere", "markerul", "markerele", "markerului", "markerelor");
    ...
    const noun_glue = new NounFemale("glue", "lipici", "lipiciuri", "lipiciul", "lipiciurile", "lipiciului", "lipiciurilor");
    ...
    const noun_paper = new NounNeuter("paper", "hârtie", "hârtii", "hârtia", "hârtiile", "hârtiei", "hârtiilor");
    const noun_pen = new NounFemale("pen", "stilou", "stilouri", "stiloul", "stilourile", "stiloului", "stilourilor");
    const noun_pencil = new NounFemale("pencil", "creion", "creioane", "creionul", "creioanele", "creionului", "creioanelor");
    ...
    const noun_scissors = new NounFemale("scissors", "foarfecă", "foarfece", "foarfeca", "foarfecele", "foarfecii", "foarfecelor");
    const noun_wastePaperBin = new NounFemale("waste paper bin", "coș de gunoi", "coșuri de gunoi", "coșul de gunoi", "coșurile de gunoi", "coșului de gunoi", "coșurilor de gunoi");
    ...
    const noun_crime = new NounNeuter("crime", "crimă", "crime", "crima", "crimele", "crimei", "crimelor");
    ...
    const noun_suspect = new NounMale("suspect", "suspect", "suspecți", "suspectul", "suspecții", "suspectului", "suspecților");
    ...
    const noun_cottonWool = new NounNeuter("cotton wool", "vată", "vete", "vata", "vetele", "vătii", "vatelor");
    ...
    const noun_diabetes = new NounMale("diabetes", "diabet", "diabete", "diabetul", "diabetele", "diabetului", "diabetelor");
    const noun_diarrhea = new NounFemale("diarrhea", "diaree", "diaree", "diareea", "diareele", "diareei", "diareelor");
    const noun_emergency = new NounFemale("emergency", "urgență", "urgențe", "urgența", "urgențele", "urgenței", "urgențelor");
    const noun_fever = new NounFemale("fever", "febra", "febre", "febra", "febrele", "febrei", "febrelor");
    const noun_flu = new NounFemale("flu", "gripă", "gripe", "gripa", "gripele", "gripei", "gripelor");
    const noun_foodPoisoning = new NounNeuter("food poisoning", "toxiinfecție alimentară", "toxiinfecții alimentare", "toxiinfecția alimentară", "toxiinfecțiile alimentare", "toxiinfecției alimentare", "toxiinfecțiilor alimentare");
    ...
    const noun_walkingStick = new NounFemale("walking stick", "baston", "bastoane", "bastonul", "bastoanele", "bastonului", "bastoanelor");
    const noun_wheelchair = new NounFemale("wheelchair", "scaun cu rotile", "scaune cu rotile", "scaunul cu rotile", "scaunele cu rotile", "scaunului cu rotile", "scaunelor cu rotile");
    ...
    const noun_bucket = new NounNeuter("bucket", "găleată", "găleți", "găleata", "gălețile", "găleții", "găleților");
    const noun_canoe = new NounFemale("canoe", "canoe", "canoe", "canoea", "canoele", "canoei", "canoelor");
    const noun_cliff = new NounNeuter("cliff", "stâncă", "stânci", "stânca", "stâncile", "stâncii", "stâncilor");
    const noun_deckchair = new NounFemale("deckchair", "șezlong", "șezlonguri", "șezlongul", "șezlongurile", "șezlongului", "șezlongurilor");
    ...
    const noun_motorBoat = new NounNeuter("motor boat", "barcă cu motor", "bărci cu motor", "barca cu motor", "bărcile cu motor", "bărcii cu motor", "bărcilor cu motor");
    const noun_paddle = new NounFemale("paddle", "pagaie", "pagaie", "pagaia", "pagaiele", "pagaiei", "pagaielor");
    const noun_pebble = new NounNeuter("pebble", "pietricică", "pietricele", "pietricica", "pietricelele", "pietricelei", "pietricelelor");
    ...
    const noun_ship = new NounNeuter("ship", "navă", "nave", "nava", "navele", "navei", "navelor");
    const noun_spade = new NounFemale("spade", "lopată", "lopeți", "lopata", "lopetele", "lopății", "lopetelor");
    ...
    const noun_umbrella = new NounNeuter("umbrella", "umbrelă", "umbrele", "umbrela", "umbrelele", "umbrei", "umbrelelor");
    const noun_wave = new NounFemale("wave", "val", "valuri", "valul", "valurile", "valului", "valurilor");
    ...
    const noun_cart = new NounFemale("cart", "car", "care", "carul", "carele", "carului", "carelor");
    ...
    const noun_farmhouse = new NounNeuter("farmhouse", "casă de fermă", "case de fermă", "casa de fermă", "casele de fermă", "casei de fermă", "caselor de fermă");
    ...
    const noun_saddle = new NounNeuter("saddle", "șea", "șei", "șeaua", "șelele", "șelei", "șelelor");
    const noun_scarecrow = new NounNeuter("scarecrow", " sperietoare de ciori", "sperietori de ciori", "sperietoarea de ciori", "sperietorile de ciori", "sperietorii de ciori", "sperietorilor de ciori");
    const noun_stable = new NounNeuter("stable", "grajd", "grajduri", "grajdul", "grajdurile", "grajdului", "grajdurilor");
    const noun_strawBale = new NounFemale("straw bale", "balot de paie", "baloți de paie", "balotul de paie", "baloții de paie", "balotului de paie", "baloților de paie");
    ...
    const noun_earth = new NounFemale("earth", "pământ", "pământuri", "pământul", "pământurile", "pământului", "pământurilor");
    ...
    const noun_flowerBed = new NounFemale("flower bed", "rond de flori", "ronduri de flori", "rondul de flori", "rondurile de flori", "rondului de flori", "rondurilor de flori");
    ...
    const noun_sandpit = new NounNeuter("sandpit", "groapă de nisip", "gropi de nisip", "groapa de nisip", "gropile de nisip", "gropii de nisip", "gropilor de nisip");
    const noun_seesaw = new NounNeuter("seesaw", "balansoar", "balansoare", "balansoarul", "balansoarele", "balansoarului", "balansoarelor");
    const noun_skippingRope = new NounFemale("skipping rope", "coardă de sărit", "corzi de sărit", "coarda de sărit", "corzile de sărit", "corzii de sărit", "corzilor de sărit");
    ...
    const noun_cafe = new NounNeuter("cafe", "cafenea", "cafenele", "cafeneaua", "cafenelele", "cafenelei", "cafenelelor");
    ...
    const noun_jackHammer = new NounNeuter("jackhammer", "picamer", "picamere", "picamerul", "picamerele", "picamerului", "picamerelor");
    ...
    const noun_lorry = new NounFemale("lorry", "camion", "camioane", "camionul", "camioanele", "camionului", "camioanelor");
    ...
    const noun_step = new NounNeuter("step", "treaptă", "trepte", "treapta", "treptele", "treptei", "treptelor");
    ...
    const noun_bonnet = new NounNeuter("bonnet", "capotă", "capote", "capota", "capotele", "capotei", "capotelor");
    ...
    const noun_controlTower = new NounFemale("control tower", "turn de control", "turnuri de control", "turnul de control", "turnurile de control", "turnului de control", "turnurilor de control");
    ...
    const noun_escalator = new NounNeuter("escalator", "scară rulantă", "scări rulante", "scara rulantă", "scările rulante", "scării rulante", "scărilor rulante");
    ...
    const noun_news = new NounNeuter("news", "știre", "știri", "știrea", "știrile", "știrii", "știrilor");
    ...
    const noun_petrolTanker = new NounNeuter("petrol tanker", "cisternă de combustibil", "cisterne de combustibil", "cisterna de combustibil", "cisternele de combustibil", "cisternei de combustibil", "cisternelor de combustibil");
    ...
    const noun_trip = new NounNeuter("trip", "excursie", "excursii", "excursia", "excursiile", "excursiei", "excursiilor");
    const noun_wheel = new NounNeuter("wheel", "roată", "roți", "roata", "roțile", "roții", "roților");
    ...
    const noun_campingTent = new NounFemale("camping tent", "cort", "corturi", "cortul", "corturile", "cortului", "corturilor");
    ...
    const noun_mountain = new NounFemale("mountain", "munte", "munți", "muntele", "munții", "muntelui", "munților");
    ...
    const noun_river = new NounMale("river", "râu", "râuri", "râul", "râurile", "râului", "râurilor");
    ...
    const noun_volcano = new NounNeuter("volcano", "vulcan", "vulcani", "vulcanul", "vulcanii", "vulcanului", "vulcanilor");
    ...
    const noun_bat = new NounFemale("bat", "liliac", "lilieci", "liliacul", "liliecii", "liliacului", "liliecilor");
    ...
    const noun_beehive = new NounFemale("beehive", "stup", "stupi", "stupul", "stupii", "stupului", "stupilor");
    ...
    const noun_calfCow = new NounNeuter("calf", "vițel", "viței", "vițelul", "vițeii", "vițelului", "vițeilor");
    const noun_camel = new NounMale("camel", "cămilă", "cămile", "cămila", "cămilele", "cămilei", "cămilelor");
    ...
    const noun_duckling = new NounNeuter("duckling", "boboc de rață", "boboci de rață", "bobocul de rață", "bobocii de rață", "bobocului de rață", "bobocilor de rață");
    const noun_eagle = new NounFemale("eagle", "vultur", "vulturi", "vulturul", "vulturii", "vulturului", "vulturilor");
    ...
    const noun_fox = new NounMale("fox", "vulpe", "vulpi", "vulpea", "vulpile", "vulpii", "vulpilor");
    const noun_foxCubs = new NounNeuter("fox cub", "pui de vulpe", "pui de vulpe", "puiul de vulpe", "puii de vulpe", "puiului de vulpe", "puilor de vulpe");
    const noun_frog = new NounFemale("frog", "broască", "broaște", "broasca", "broaștele", "broaștii", "broaștelor");
    ...
    const noun_guineaPig = new NounNeuter("guinea pig", "porcușor de Guineea", "porcușori de Guineea", "porcușorul de Guineea", "porcușorii de Guineea", "porcușorului de Guineea", "porcușorilor de Guineea");
    ...
    const noun_kitten = new NounNeuter("kitten", "pisoi", "pisoi", "pisoiul", "pisoii", "pisoiului", "pisoiilor");
    const noun_ladybird = new NounFemale("ladybird", "buburuză", "buburuze", "buburuza", "buburuzele", "buburuzei", "buburuzelor");
    const noun_lamb = new NounNeuter("lamb", "miel", "miei", "mielul", "mieii", "mielului", "mielilor");
    ...
    const noun_lionCub = new NounNeuter("lion cub", "pui de leu", "pui de leu", "puiul de leu", "puii de leu", "puiului de leu", "puilor de leu");
    const noun_lizard = new NounFemale("lizard", "șopârlă", "șopârle", "șopârla", "șopârlele", "șopârlei", "șopârlelor");
    const noun_mole = new NounMale("mole", "cârtiță", "cârtițe", "cârtița", "cârtițele", "cârtiței", "cârtițelor");
    ...
    const noun_panda = new NounMale("panda", "panda", "panda", "panda", "panda", "pandei", "pandelor");
    ...
    const noun_petFood = new NounNeuter("pet food", "hrană pentru animale", "hrane pentru animale", "hrana pentru animale", "hranele pentru animale", "hranei pentru animale", "hranelor pentru animale");
    ...
    const noun_piglet = new NounNeuter("piglet", "purcel", "purcei", "purcelul", "purceii", "purcelului", "purceilor");
    const noun_pony = new NounMale("pony", "ponei", "ponei", "poneiul", "poneii", "poneiului", "poneilor");
    const noun_puppy = new NounNeuter("puppy", "căţeluş", "căţeluşi", "căţeluşul", "căţeluşii", "căţeluşului", "căţeluşilor");
    ...
    const noun_seagull = new NounFemale("seagull", "pescăruș", "pescăruși", "pescărușul", "pescărușii", "pescărușului", "pescărușilor");
    const noun_seal = new NounMale("seal", "focă", "foci", "foca", "focile", "focii", "focilor");
    ...
    const noun_trunk = new NounMale("trunk", "trompă", "trompe", "trompa", "trompele", "trompei", "trompelor");
    ...
    const noun_whale = new NounMale("whale", "balenă", "balene", "balena", "balenele", "balenei", "balenelor");
    const noun_wing = new NounNeuter("wing", "aripă", "aripi", "aripa", "aripile", "aripii", "aripilor");
    ...
    const noun_checkout = new NounNeuter("checkout", "casă de marcat", "case de marcat", "casa de marcat", "casele de marcat", "casei de marcat", "caselor de marcat");
    ...
    const noun_scales = new NounFemale("scales", "cântar", "cântare", "cântarul", "cântarele", "cântarului", "cântarelor");
    ...
    const noun_breadRolls = new NounNeuter("bread rolls", "chiflă", "chifle", "chifla", "chiflele", "chiflei", "chiflelor");
    ...
    const noun_carrot = new NounFemale("carrot", "morcov", "morcovi", "morcovul", "morcovii", "morcovului", "morcovilor");
    const noun_cauliflower = new NounFemale("cauliflower", "conopidă", "conopide", "conopida", "conopidele", "conopidei", "conopidelor");
    const noun_celery = new NounMale("celery", "țelină", "țeline", "țelina", "țelinele", "țelinei", "țelinelor");
    const noun_cereal = new NounNeuter("cereal", "cereală", "cereale", "cereala", "cerealele", "cerealei", "cerealelor");
    ...
    const noun_chicken = new NounFemale("chicken", "pui", "pui", "puiul", "puii", "puiului", "puilor");
    const noun_chips = new NounFemale("chips", "cartofi prăjiți", "cartofi prăjiți", "cartofii prăjiți", "cartofii prăjiți", "cartofilor prăjiți", "cartofilor prăjiți");
    const noun_chopsticks = new NounFemale("chopsticks", "bețișor", "bețișoare", "bețișorul", "bețișoarele", "bețișorului", "bețișoarelor");
    ...
    const noun_cream = new NounFemale("cream", "smântână", "smântâni", "smântâna", "smântânile", "smântânii", "smântânilor");
    ...
    const noun_ham = new NounNeuter("ham", "șuncă", "șunci", "șunca", "șuncile", "șuncii", "șuncilor");
    const noun_hamburger = new NounMale("hamburger", "hamburger", "hamburgeri", "hamburgerul", "hamburgerii", "hamburgerului", "hamburgerilor");
    const noun_honey = new NounNeuter("honey", "miere", "mieri", "mierea", "mierile", "mierii", "mierilor");
    const noun_hotChocolate = new NounNeuter("hot chocolate", "ciocolată caldă", "ciocolate calde", "ciocolata caldă", "ciocolatele calde", "ciocolatei calde", "ciocolatelor calde");
    ...
    const noun_ketchup = new NounNeuter("ketchup", "ketchup", "ketchupuri", "ketchupul", "ketchupurile", "ketchupului", "ketchupurilor");
    const noun_leek = new NounMale("leek", "praz", "prazi", "prazul", "prazii", "prazului", "prazilor");
    const noun_lemon = new NounMale("lemon", "lămâie", "lămâi", "lămâia", "lămâile", "lămâii", "lămâilor");
    ...
    const noun_meat = new NounNeuter("meat", "carne", "cărnuri", "carnea", "cărnurile", "cărnii", "cărnurilor");
    const noun_melon = new NounNeuter("melon", "pepene", "pepeni", "pepenele", "pepenii", "pepenelui", "pepenilor");
    const noun_milk = new NounNeuter("milk", "lapte", "lapte", "laptele", "laptele", "laptelui", "laptelui");
    ...
    const noun_peas = new NounFemale("peas", "mazăre", "mazăre", "mazărea", "mazărea", "mazărei", "mazărei");
    const noun_pepper = new NounNeuter("pepper", "piper", "piperuri", "piperul", "piperurile", "piperului", "piperurilor");
    ...
    const noun_pudding = new NounNeuter("pudding", "budincă", "budinci", "budinca", "budincile", "budincii", "budincilor");
    const noun_pumpkin = new NounFemale("pumpkin", "dovleac", "dovleci", "dovleacul", "dovlecii", "dovleacului", "dovlecilor");
    ...
    const noun_salt = new NounNeuter("salt", "sare", "săruri", "sarea", "sările", "sării", "sărilor");
    const noun_softDrink = new NounNeuter("soft drink", "băutură răcoritoare", "băuturi răcoritoare", "băutura răcoritoare", "băuturile răcoritoare", "băuturii răcoritoare", "băuturilor răcoritoare");
    const noun_soup = new NounFemale("soup", "supă", "supe", "supa", "supele", "supei", "supelor");
    const noun_spaghetti = new NounFemale("spaghetti", "spaghete", "spaghete", "spagheta", "spaghetele", "spaghetei", "spaghetelor");
    ...
    const noun_sugar = new NounNeuter("sugar", "zahăr", "zahăruri", "zahărul", "zahărurile", "zahărului", "zahărurilor");
    ...
    const noun_humanResources = new NounFemale("human resources", "resurse umane", "resurse umane", "resursa umană", "resursele umane", "resursei umane", "resurselor umane");
    const noun_job = new NounNeuter("job", "loc de muncă", "locuri de muncă", "locul de muncă", "locurile de muncă", "locului de muncă", "locurilor de muncă");
    ...
    const noun_barrel = new NounFemale("barrel", "butoi", "butoaie", "butoiul", "butoaiele", "butoiului", "butoaielor");
    const noun_bolts = new NounMale("bolt", "șurub", "șuruburi", "șurubul", "șuruburile", "șurubului", "șuruburilor");
    ...
    const noun_jars = new NounFemale("jar", "borcan", "borcane", "borcanul", "borcanele", "borcanului", "borcanelor");
    const noun_ladder = new NounFemale("ladder", "scară", "scări", "scara", "scările", "scării", "scărilor");
    const noun_nails = new NounMale("nail", "cuie", "cuie", "cuiul", "cuiele", "cuiului", "cuielor");
    const noun_nuts = new NounFemale("nuts", "piuliță", "piulițe", "piulița", "piulițele", "piuliței", "piulițelor");
    ...
    const noun_pliers = new NounFemale("pliers", "clește", "clești", "cleștele", "cleștii", "cleștelui", "cleștilor");
    const noun_sandpaper = new NounNeuter("sandpaper", "șmirghel", "șmirghele", "șmirghelul", "șmirghelele", "șmirghelului", "șmirghelelor");
    const noun_saw = new NounFemale("saw", "ferăstrău", "ferăstraie", "ferăstrăul", "ferăstraiele", "ferăstrăului", "ferăstraielor");
    const noun_sawdust = new NounNeuter("sawdust", "rumeguș", "rumegușuri", "rumegușul", "rumegușurile", "rumegușului", "rumegușurilor");
    ...
    const noun_screws = new NounMale("screw", "șurub", "șuruburi", "șurubul", "șuruburile", "șurubului", "șuruburilor");
    const noun_tapeMeasure = new NounFemale("tape measure", "ruletă", "rulete", "ruleta", "ruletele", "ruletei", "ruletei");
    ...
    const noun_woodShavings = new NounNeuter("wood shavings", "așchii de lemn", "așchii de lemn", "așchia de lemn", "așchiile de lemn", "așchiei de lemn", "așchiilor de lemn");
    ...
    const noun_grass = new NounNeuter("grass", "iarbă", "ierburi", "iarba", "ierburile", "ierbii", "ierburilor");
    const noun_greenhouse = new NounFemale("greenhouse", "seră", "sere", "sera", "serele", "serei", "serelor");
    const noun_hedge = new NounFemale("hedge", "gard viu", "gărzi vii", "gardul viu", "gărzile vii", "gardului viu", "gardurilor vii");
    const noun_hoe = new NounFemale("hoe", "sapa", "sape", "sapa", "sapele", "sapei", "sapelor");
    const noun_hosepipe = new NounFemale("hosepipe", "furtun", "furtunuri", "furtunul", "furtunurile", "furtunului", "furtunurilor");
    ...
    const noun_seed = new NounNeuter("seed", "sămânță", "semințe", "sămânța", "semințele", "seminței", "semințelor");
    ...
    const noun_stick = new NounMale("stick", "băț", "bețe", "bățul", "bețele", "bățului", "bețelor");
    const noun_tree = new NounMale("tree", "copac", "copaci", "copacul", "copacii", "copacului", "copacilor");
    const noun_trowel = new NounFemale("trowel", "gletieră", "gletiere", "gletiera", "gletierele", "gletierei", "gletierelor");
    const noun_vegetable = new NounNeuter("vegetable", "legumă", "legume", "leguma", "legumele", "legumei", "legumelor");
    ...
    const noun_wheelbarrow = new NounNeuter("wheelbarrow", "roabă", "roabe", "roaba", "roabele", "roabei", "roabelor");
    ...
    const noun_bowl = new NounFemale("bowl", "bol", "boluri", "bolul", "bolurile", "bolului", "bolurilor");
    const noun_broom = new NounFemale("broom", "mătură", "mături", "mătura", "măturile", "măturii", "măturilor");
    const noun_broomCupboard = new NounFemale("broom cupboard", "dulap pentru mături", "dulapuri pentru mături", "dulapul pentru mături", "dulapurile pentru mături", "dulapului pentru mături", "dulapurilor pentru mături");
    const noun_brush = new NounFemale("brush", "perie", "perii", "peria", "periile", "periei", "periilor");
    const noun_clock = new NounFemale("clock", "ceas", "ceasuri", "ceasul", "ceasurile", "ceasului", "ceasurilor");
    ...
    const noun_cooker = new NounFemale("cooker", "aragaz", "aragazuri", "aragazul", "aragazurile", "aragazului", "aragazurilor");
    ...
    const noun_dustpan = new NounFemale("dustpan", "făraș", "fărașe", "fărașul", "fărașele", "fărașului", "fărașelor");
    ...
    const noun_fridge = new NounFemale("fridge", "frigider", "frigidere", "frigiderul", "frigiderele", "frigiderului", "frigiderelor");
    ...
    const noun_kitchenSink = new NounNeuter("kitchen sink", "chiuvetă", "chiuvete", "chiuveta", "chiuvetele", "chiuvetei", "chiuvetelor");
    ...
    const noun_matchFire = new NounFemale("match", "chibrit", "chibrituri", "chibritul", "chibriturile", "chibritului", "chibriturilor");
    const noun_mop = new NounFemale("mop", "mop", "mopuri", "mopul", "mopurile", "mopului", "mopurilor");
    ...
    const noun_teaTowel = new NounFemale("tea towel", "prosop de bucătărie", "prosoape de bucătărie", "prosopul de bucătărie", "prosoapele de bucătărie", "prosopului de bucătărie", "prosoapelor de bucătărie");
    ...
    const noun_vacuumCleaner = new NounMale("vacuum cleaner", "aspirator", "aspiratoare", "aspiratorul", "aspiratoarele", "aspiratorului", "aspiratoarelor");
    ...
    const noun_washingPowder = new NounNeuter("washing powder", "detergent pudră", "detergenți pudră", "detergentul pudră", "detergenții pudră", "detergentului pudră", "detergenților pudră");
    ...
    const noun_bathroom = new NounNeuter("bathroom", "baie", "băi", "baia", "băile", "băii", "băilor");
    ...
    const noun_bookshelf = new NounFemale("bookshelf", "raft de cărți", "rafturi de cărți", "raftul de cărți", "rafturile de cărți", "raftului de cărți", "rafturilor de cărți");
    ...
    const noun_chair = new NounFemale("chair", "scaun", "scaune", "scaunul", "scaunele", "scaunului", "scaunelor");
    const noun_chestOfdrawers = new NounFemale("chest of drawers", "comodă", "comode", "comoda", "comodele", "comodei", "comodelor");
    const noun_clothesPeg = new NounFemale("clothes peg", "cârlig de rufe", "cârlige de rufe", "cârligul de rufe", "cârligele de rufe", "cârligului de rufe", "cârligelor de rufe");
    const noun_comb = new NounNeuter("comb", "pieptene", "piepteni", "pieptenele", "pieptenii", "pieptenelui", "pieptenilor");
    ...
    const noun_cushion = new NounNeuter("cushion", "pernă decorativă", "perne decorative", "perna decorativă", "pernele decorative", "pernei decorative", "pernelor decorative");
    const noun_duvet = new NounNeuter("duvet", "pilotă", "pilote", "pilota", "pilotele", "pilotei", "pilotelor");
    ...
    const noun_eyeGlasses = new NounFemale("eyeglasses", "ochelari", "ochelari", "ochelarii", "ochelarii", "ochelarilor", "ochelarilor");
    ...
    const noun_floor = new NounNeuter("floor", "podea", "podele", "podeaua", "podelele", "podelei", "podelelor");
    ...
    const noun_laundry = new NounNeuter("laundry", "rufe", "rufe", "rufele", "rufele", "rufelor", "rufelor");
    const noun_letter = new NounFemale("letter", "scrisoare", "scrisori", "scrisoarea", "scrisorile", "scrisorii", "scrisorilor");
    const noun_lightbulb = new NounFemale("lightbulb", "bec", "becuri", "becul", "becurile", "becului", "becurilor");
    const noun_livingRoom = new NounNeuter("living room", "sufragerie", "sufragerii", "sufrageria", "sufrageriile", "sufrageriei", "sufrageriilor");
    const noun_mat = new NounNeuter("mat", "preș", "preșuri", "preșul", "preșurile", "preșului", "preșurilor");
    const noun_mirror = new NounNeuter("mirror", "oglindă", "oglinzi", "oglinda", "oglinzile", "oglinzii", "oglinzilor");
    ...
    const noun_sponge = new NounFemale("sponge", "burete", "bureți", "buretele", "bureții", "buretelui", "bureților");
    ...
    const noun_toiletPaper = new NounNeuter("toilet paper", "hârtie igienică", "hârtii igienice", "hârtia igienică", "hârtiile igienice", "hârtiei igienice", "hârtiilor igienice");
    ...
    const noun_wall = new NounFemale("wall", "perete", "pereți", "peretele", "pereții", "peretelui", "pereților");
    const noun_wardrobe = new NounFemale("wardrobe", "dulap", "dulapuri", "dulapul", "dulapurile", "dulapului", "dulapurilor");
    const noun_water = new NounNeuter("water", "apă", "ape", "apa", "apele", "apei", "apelor");
    ...
    const noun_diamond = new NounNeuter("diamond (shape)", "romb", "romburi", "rombul", "romburile", "rombului", "romburilor");
    ...
    const noun_cheek = new NounFemale("cheek", "obraz", "obraji", "obrazul", "obrajii", "obrazului", "obrajilor");
    const noun_chest = new NounNeuter("chest", "piept", "piepturi", "pieptul", "piepturile", "pieptului", "piepturilor");
    const noun_chin = new NounNeuter("chin", "bărbie", "bărbii", "bărbia", "bărbiile", "bărbiei", "bărbiilor");
    ...
    const noun_eye = new NounNeuter("eye", "ochi", "ochi", "ochiul", "ochii", "ochiului", "ochilor");
    const noun_eyebrow = new NounFemale("eyebrow", "sprânceană", "sprâncene", "sprânceana", "sprâncenele", "sprâncenei", "sprâncenelor");
    const noun_face = new NounNeuter("face", "față", "fețe", "fața", "fețele", "feței", "fețelor");
    const noun_finger = new NounNeuter("finger", "deget", "degete", "degetul", "degetele", "degetului", "degetelor");
    const noun_foot = new NounFemale("foot", "picior", "picioare", "piciorul", "picioarele", "piciorului", "picioarelor");
    const noun_hair = new NounNeuter("hair", "păr", "păr", "părul", "părul", "părului", "părului"); // uncountable
    const noun_hand = new NounFemale("hand", "mână", "mâini", "mâna", "mâinile", "mâinii", "mâinilor");
    const noun_head = new NounFemale("head", "cap", "capete", "capul", "capetele", "capului", "capetelor");
    const noun_knee = new NounNeuter("knee", "genunchi", "genunchi", "genunchiul", "genunchii", "genunchiului", "genunchilor");
    const noun_leg = new NounFemale("leg", "gleznă", "glezne", "glezna", "gleznele", "gleznei", "gleznelor");
    ...
    const noun_nose = new NounFemale("nose", "nas", "nasuri", "nasul", "nasurile", "nasului", "nasurilor");
    const noun_shoulder = new NounNeuter("shoulder", "umăr", "umeri", "umărul", "umerii", "umărului", "umerilor");
    ...
    const noun_tummy = new NounNeuter("tummy", "burtă", "burți", "burta", "burțile", "burții", "burților");
